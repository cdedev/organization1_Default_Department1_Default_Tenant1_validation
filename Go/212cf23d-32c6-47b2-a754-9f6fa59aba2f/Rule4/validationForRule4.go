...
import (
	...
	"strconv"
	"strings"
	parser "organization1_Default_Department1_Default_Tenant1_validation/Go/212cf23d-32c6-47b2-a754-9f6fa59aba2f/Rule4/parser"
...
expression :  field1 field2 EOF ;

field1 : FIELD1 ;

field2 : FIELD2 ;

FIELD1 :SPLITKEY  OWNKEY [0-9] [0-9] [0-9] [0-9] [0-9] [0-9] [0-9] [0-9] [0-9] [0-9] [0-9] [0-9] ;

FIELD2 :SPLITKEY  OWNKEY OWNKEY [0-9A-Za-z .]* ;
